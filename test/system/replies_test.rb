...
class RepliesTest < ApplicationSystemTestCase
  ...
  test "creating a Reply" do
    ...
    fill_in "Listing", with: @reply.listing_id
    fill_in "Message", with: @reply.message
    fill_in "Organisations profile", with: @reply.organisations_profile_id
    fill_in "Users profile", with: @reply.users_profile_id
